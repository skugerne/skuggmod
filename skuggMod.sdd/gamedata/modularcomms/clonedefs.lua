...
local copy = {
	armcom1 = {
		...
		armcom2 = {
			level = 2,
			mainstats = {maxdamage = 3000, autoheal = 12.5, objectname = "armcom2.s3o", collisionvolumescales  = [[50 55 50]], aimposoffset = [[0 6 0]],},
			customparams = {modelradius = [[28]],},
			wreckmodel = "armcom2_dead.s3o",
		},
		armcom3 = {
			level = 3,
			mainstats = {maxdamage = 4000, autoheal = 20, objectname = "armcom3.s3o", collisionvolumescales  = [[55 60 55]], aimposoffset = [[0 7 0]],},
			customparams = {modelradius = [[30]],},
			wreckmodel = "armcom3_dead.s3o",
		},
		armcom4 = {
			level = 4,
			mainstats = {maxdamage = 5000, autoheal = 27.5, objectname = "armcom4.s3o", collisionvolumescales  = [[60 65 60]], aimposoffset = [[0 8 0]],},
			customparams = {modelradius = [[33]],},
			wreckmodel = "armcom4_dead.s3o",
		},
		armcom5 = {
			level = 5,
			mainstats = {maxdamage = 6000, autoheal = 35, objectname = "armcom5.s3o", collisionvolumescales  = [[65 70 65]], aimposoffset = [[0 9 0]],},
	...
	dynstrike1 = {
		...
		dynstrike2 = {
			level = 2,
			mainstats = {objectname = "strikecom_1.dae", collisionvolumescales  = [[50 55 50]],},
			customparams = {modelradius = [[28]], shield_emit_height = 41.8},
			wreckmodel = "strikecom_dead_1.dae",
		},
		dynstrike3 = {
			level = 3,
			mainstats = {objectname = "strikecom_2.dae", collisionvolumescales  = [[55 60 55]],},
			customparams = {modelradius = [[30]], shield_emit_height = 45.6},
			wreckmodel = "strikecom_dead_2.dae",
		},
		dynstrike4 = {
			level = 4,
			mainstats = {objectname = "strikecom_3.dae", collisionvolumescales  = [[58 66 58]],},
			customparams = {modelradius = [[33]], shield_emit_height = 47.5},
			wreckmodel = "strikecom_dead_3.dae",
		},
		dynstrike5 = {
			level = 5,
			mainstats = {objectname = "strikecom_4.dae", collisionvolumescales  = [[60 72 60]],},
	...
	dynrecon1 = {
		...
		dynrecon2 = {
			level = 2,
			mainstats = {objectname = "commrecon2.s3o", aimposoffset = [[0 12 0]]},
			customparams = {shield_emit_height = 33},
			wreckmodel = "commrecon2_dead.s3o",
		},
		dynrecon3 = {
			level = 3,
			mainstats = {objectname = "commrecon3.s3o", aimposoffset = [[0 14 0]]},
			customparams = {shield_emit_height = 36},
			wreckmodel = "commrecon3_dead.s3o",
		},
		dynrecon4 = {
			level = 4,
			mainstats = {objectname = "commrecon4.s3o", aimposoffset = [[0 16 0]]},
			customparams = {shield_emit_height = 37.5},
			wreckmodel = "commrecon4_dead.s3o",
		},
		dynrecon5 = {
			level = 5,
			mainstats = {objectname = "commrecon5.s3o", aimposoffset = [[0 18 0]]},
	...
	dynsupport1 = {
		...
		dynsupport2 = {
			level = 2,
			mainstats = {objectname = "commsupport2.s3o", aimposoffset = [[0 17 0]], builddistance = 244},
			customparams = {shield_emit_height = 39.6},
			wreckmodel = "commsupport2_dead.s3o",
		},
		dynsupport3 = {
			level = 3,
			mainstats = {objectname = "commsupport3.s3o", aimposoffset = [[0 19 0]], builddistance = 256},
			customparams = {shield_emit_height = 43.62},
			wreckmodel = "commsupport3_dead.s3o",
		},
		dynsupport4 = {
			level = 4,
			mainstats = {objectname = "commsupport4.s3o", aimposoffset = [[0 22 0]], builddistance = 268},
			customparams = {shield_emit_height = 45},
			wreckmodel = "commsupport4_dead.s3o",
		},
		dynsupport5 = {
			level = 5,
			mainstats = {mobjectname = "commsupport5.s3o", aimposoffset = [[0 25 0]], builddistance = 280},
	...
	dynassault1 = {
		...
		dynassault2 = {
			...
			mainstats = {objectname = "benzcom2.s3o"},
		...
		dynassault3 = {
			level = 3,
			collisionvolumescales  = [[55 65 55]],
			mainstats = {objectname = "benzcom3.s3o",},
		...
		dynassault4 = {
			...
			mainstats = {objectname = "benzcom4.s3o",},
		...
		dynassault5 = {
			...
			mainstats = {objectname = "benzcom5.s3o",},
	...
	dynriot1 = {
		...
		dynriot2 = {
			level = 2,
			mainstats = {objectname = "corcomAlt2.s3o", aimposoffset = [[0 6 0]], },
			wreckmodel = "corcom2_dead.s3o",
		},
		dynriot3 = {
			level = 3,
			mainstats = {objectname = "corcomAlt3.s3o", aimposoffset = [[0 7 0]], },
			wreckmodel = "corcom3_dead.s3o",
		},
		dynriot4 = {
			level = 4,
			mainstats = {objectname = "corcomAlt4.s3o", aimposoffset = [[0 8 0]], },
			wreckmodel = "corcom4_dead.s3o",
		},
		dynriot5 = {
			level = 5,
			mainstats = {objectname = "corcomAlt5.s3o", aimposoffset = [[0 9 0]], },
			wreckmodel = "corcom5_dead.s3o",
		},
	},
	dynknight1 = {
		...
		dynknight2 = {
			level = 2,
			mainstats = {objectname = "cremcom2.s3o", collisionvolumescales  = [[50 55 50]],},
			customparams = {modelradius = [[28]], shield_emit_height = 33},
			wreckmodel = "cremcom2_dead.s3o",
		},
		dynknight3 = {
			level = 3,
			mainstats = {objectname = "cremcom3.s3o", collisionvolumescales  = [[55 60 55]],},
			customparams = {modelradius = [[30]], shield_emit_height = 36},
			wreckmodel = "cremcom3_dead.s3o",
		},
		dynknight4 = {
			level = 4,
			mainstats = {objectname = "cremcom4.s3o", collisionvolumescales  = [[60 65 60]],},
			customparams = {modelradius = [[33]], shield_emit_height = 37.5},
			wreckmodel = "cremcom4_dead.s3o",
		},
		dynknight5 = {
			level = 5,
			mainstats = {objectname = "cremcom5.s3o", collisionvolumescales  = [[65 70 65]],},
